        ...
        <DialogContent className="w-[95vw] sm:w-[90vw] md:max-w-[1000px] p-0 bg-white overflow-hidden max-h-[95vh] rounded-lg">
          {selectedImage && (
            <div className="flex flex-col items-center justify-center gap-2 sm:gap-3 md:gap-4 p-3 sm:p-4 md:p-6 bg-white max-h-[95vh] overflow-y-auto">
              ...
              <div 
                className="overflow-hidden rounded-lg border-2 border-slate-300 w-full h-[200px] sm:h-[350px] md:h-[900px] cursor-grab active:cursor-grabbing bg-white flex items-center justify-center transition-all hover:border-primary hover:shadow-lg"
