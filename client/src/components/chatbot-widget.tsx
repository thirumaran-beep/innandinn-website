    ...
    <div className="fixed bottom-6 right-6 z-50">
      {isOpen && (
        <div className="absolute bottom-20 right-0 w-96 max-w-[90vw] bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl shadow-2xl flex flex-col animate-in fade-in zoom-in-95 duration-300">
          {/* Header */}
          <div className="bg-gradient-to-r from-[#123E78] to-[#123E78]/80 text-white p-4 rounded-t-xl flex items-center justify-between">
              ...
              >
                <div
                  className={cn(
                    ...
                    msg.sender === "user"
                      ? "bg-[#123E78] text-white rounded-br-none"
          ...
          <div className="border-t border-slate-200 dark:border-slate-800 p-3 flex gap-2 bg-slate-50 dark:bg-slate-900 rounded-b-xl">
            <input
              ...
              className="flex-1 px-3 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded text-sm focus:outline-none focus:ring-2 focus:ring-[#123E78] dark:text-white"
              data-testid="chatbot-input"
            />
            <Button
              size="sm"
              onClick={handleSendMessage}
              className="bg-[#123E78] hover:bg-[#123E78]/90"
